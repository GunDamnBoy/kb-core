...
register(Check(
    ...
    blind_to=[
        "**沒有到期日的項目**：全部集中在 2026-08-22 強制 `due` 之前，數量沒有再增加、"
        "但佔比隨分母浮動，**所以這裡不記百分比**（08-22 是 61 條裡 52 條、08-23 是 64 條裡 52 條、"
        "09-02 是 88 條裡 47 條；**現況一律看 `healthcheck.py` 的觀察點記分板**）。它們的"

...
> **2026-09-13：第四次，成因是登記簿裡並存兩種格式，而錨只綁其中一種。**
> `### 逐場登記` 那張速查表最新一列停在 **08-30**，於是「本檔 mtime 比它舊就先讀」判定為「不舊」、不觸發。
> **但 08-31／09-02／09-03 三場其實都登記了** —— 登記在第 12 節上方的
> `### 2026-08-31`／`### 2026-09-02`／`### 2026-09-03` 三個區塊裡，各自帶著同樣的三欄表。
> **08-24 兩種格式都寫、08-30 只寫速查表那一列、這三場只寫區塊，而沒有人規定用哪一種。**
> **所以錨沒有死，是它只看得到兩種登記格式裡的一種。**
> （**本條初版把成因寫成「錨本身停止前進」、還說那三場「一列都沒有、記在第 7 節」——
> 兩句都是錯的，同日由複驗子代理實跑行號推翻。** 第 7 節底下只有一個主題無關的 08-31。
> **一個沒有查證的因果宣稱會把修法導向錯的地方**：照初版去修會去催人補登，
> 而真正該修的是格式分歧。這正是本檔第 82 行那條「用來查漂移的文件自己帶著錯」的實例。）
>
> **修法兩條，09-13 只做了第二條：**
> （一）**統一格式**，或把錨改成「第 12 節裡最新的日期，不論它是一列還是一個區塊」——**留給下一場**。
> （二）**加一條不依賴錨的絕對條件**（已做）：
> **速查表最新那一列的日期若比今天舊超過 7 天，先當它是停更了** ——
> 去第 12 節上方看那段期間有沒有 `###` 區塊，有的話那幾場的比對關係一項都沒進過本檔。
> 7 天的理由：這套系統的維護頻率是數天一場，連續七天沒有任何一場是可能的，
> **但「七天沒有一場」與「有場次而沒有進速查表」在那張表上長得一模一樣** —— 這條要求你去分辨那兩者。
> **一個相對條件的兩端都必須是活的，而且錨要看得見所有形式的前進。**

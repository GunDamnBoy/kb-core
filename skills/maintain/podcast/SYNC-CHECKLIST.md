...
> **2026-09-13：第四次，而這一次是錨本身停止前進——前三次都是「條件太晚亮」，這次是它死了。**
> 登記簿最新一列停在 **08-30**，而 08-31／09-02／09-03 三場**一列都沒有**（第 7 節有完整記載）。
> 本檔 mtime 是 09-03 —— **比 08-30 新，所以上面那個「本檔比登記簿舊就先讀」的條件判定為「不舊」、不觸發**。
> **它沒有亮，不是因為清單跟上了，是因為它拿來比較的東西不動了。**
> **所以再加一條絕對條件，它不依賴任何一份文件有沒有被更新**：
> **登記簿最新那一列的日期若比今天舊超過 7 天，先當它是停更了** ——
> 去第 7 節看那段期間有沒有事故記載，有的話那幾場的比對關係一項都沒進過本檔。
> 7 天的理由：這套系統的維護頻率是數天一場，連續七天沒有任何一場是可能的，
> **但「七天沒有一場」與「有場次而沒有人登記」在登記簿上長得一模一樣** —— 這條要求你去分辨那兩者。
> **一個相對條件的兩端都必須是活的**：前三次修的是「錨選錯了」「錨太晚」，
> 而這次暴露的是**沒有人檢查錨自己還有沒有在動**。
